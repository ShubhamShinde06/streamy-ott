              ...
              {selectedSeason?.episodes?.length > 0 ? (
                selectedSeason.episodes.map((episode) => (
                  <>
                    <div
                      key={episode.id}
                      className="hover:bg-[#7a7a937c]  hover:rounded-md flex justify-between items-center py-5 lg:py-10 px-5 lg:px-10 lg:gap-10 gap-4 border-b-2 border-[#8989ac] hover-box w-full"
                    >
