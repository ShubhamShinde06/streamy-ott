    ...
    <div className="w-full h-[100vh] bg-black px-2 py-5 flex flex-col gap-6">
            ...
            <div className=" flex items-center gap-3">
              ...
              <div>
                <h1 className=" hidden lg:block  lg:text-3xl ">
                  ...
                  <br />
                  <span className=" font-bold tracking-wide">Episode Number:</span> {data?.episode_number}
                </h1>
              </div>
            </div>
            <div>
          ...
          <div className=" text-center">
            <h1 className=" block lg:hidden text-xl ">
              ...
              <br></br>
              <span className=" font-bold tracking-wide mt-5">Episode Number:</span> {data?.episode_number}
            </h1>
          </div>
        </div>
  )
